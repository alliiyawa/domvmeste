...
class AnnouncementsBloc extends Bloc<AnnouncementsEvent, AnnouncementsState> {
 ...
 super(AnnouncementInitialState()) {
  ...
  on<_AnnouncementUpdatedEvent>((event, emit) => emit(AnnouncementLoadedState(announcements: event.announcements)));
    on<_AnnouncementsErrorEvent>((event, emit) => emit(AnnouncementsErrorState(message: event.message)));
  ...
  FutureOr<void> _onAdd(AnnouncementsAddEvent event, Emitter<AnnouncementsState> emit) async {
    try {
      ...
      } catch (e) { emit(AnnouncementsErrorState(message: e.toString()));
    }
  }
  
  FutureOr<void> _onDelete(AnnouncementsDeleteEvent event, Emitter<AnnouncementsState> emit) async {
    try {
